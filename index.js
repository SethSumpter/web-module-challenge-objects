...
console.log('1:', createMenuItem('tacos', 8, 'Lunch'));
...
console.log('1b:', createMenuItem('breakfast burrito', 7, 'breakfast'));
console.log('1b:', createMenuItem('german homefries', 10, 'brunch'));
...
console.log('2:', burger.discount('teacher'));
...
console.log('7:', getReviewByIndex(reviews, 4));
